<h2><a href="https://leetcode.com/problems/maximum-valid-pair-sum/description/">3979. Maximum Valid Pair Sum</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and an integer <code>k</code>.</p>
