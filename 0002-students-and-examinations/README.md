<h2><a href="https://leetcode.com/problems/customers-who-bought-all-products/description/?envType=problem-list-v2&envId=db-db3-grouping-aggregation">2. Students and Examinations</a></h2><h3>Easy</h3><hr><p>Table: <code>Students</code></p>
